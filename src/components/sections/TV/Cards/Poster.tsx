    ...
    <>
      ...
      >
        <Link href={`/tv/${tv.id}`} ref={ref} {...longPress()}>
          {variant === "full" && (
            <div className="group motion-preset-focus relative aspect-2/3 overflow-hidden rounded-lg border-[2px] border-transparent text-white transition-all duration-300 hover:border-yellow-400/70 hover:shadow-[0_0_20px_rgba(255,215,0,0.25)]">
              {hovered && (
                <Icon

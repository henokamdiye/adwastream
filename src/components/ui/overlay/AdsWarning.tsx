...
const AdsWarning: React.FC = () => {
  ...
  return (
    ...
    >
      <ModalContent>
        <ModalHeader className="flex flex-col gap-1 items-center text-center text-2xl uppercase">
          <span style={{fontFamily:"var(--font-bebas),sans-serif",background:"linear-gradient(135deg,#b8860b,#ffd700,#b8860b)",WebkitBackgroundClip:"text",backgroundClip:"text",WebkitTextFillColor:"transparent",letterSpacing:"0.08em",fontSize:"2rem"}}>AdwaStream</span>
          <span className="text-lg">Before You Watch</span>
        </ModalHeader>
        <ModalBody>
